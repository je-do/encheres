...
/**
 * Servlet implementation class VenteRemporteParPseudo
 */
@WebServlet("/VenteRemporteParPseudo")
public class VenteRemporteParPseudo extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private ArticleManager manager = ArticleManagerImpl.getInstance();
	Article articleRecupere = new Article();
	
	// Correspond a la servlet de la page Jojo44 a remporté l'enchère sur le PDF
	
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public VenteRemporteParPseudo() {
        super();
